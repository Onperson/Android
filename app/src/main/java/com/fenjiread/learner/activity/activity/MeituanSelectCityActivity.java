...
import com.fenjiread.learner.activity.adapter.MeituanAdapter;
import com.fenjiread.learner.activity.model.MeiTuanBean;
import com.fenjiread.learner.activity.model.MeituanHeaderBean;
import com.fenjiread.learner.activity.model.MeituanTopHeaderBean;
import com.fenjiread.learner.activity.utils.CommonAdapter;
import com.fenjiread.learner.activity.utils.HeaderRecyclerAndFooterWrapperAdapter;
import com.fenjiread.learner.activity.utils.ViewHolder;
import com.fenjiread.learner.activity.widget.IndexBar.bean.BaseIndexPinyinBean;
import com.fenjiread.learner.activity.widget.IndexBar.suspension.SuspensionDecoration;
import com.fenjiread.learner.activity.widget.IndexBar.widget.IndexBar;
...
public class MeituanSelectCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRv.addItemDecoration(mDecoration = new SuspensionDecoration(this, mSourceDatas)
                ...
                .setTitleFontSize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14,
                        getResources().getDisplayMetrics()))
